...
static uinteg8_t sgu8_LCD_Execution_Time=LCD_Execution_Delay_Enable;
...
{
	  static uinteg8_t su8_LCD_command_state=1;
	  static uinteg8_t su8_LCD_init_state=0;
...
{
    static uinteg8_t su8_Command_State=0;
...
{
	uinteg8_t u8_index_Polling_String = 0;
	static uinteg8_t u8_index_Time_event_string = 0;
	static uinteg8_t u8_LCD_displayString_FLag=1;
...
void LCD_goToRowColumn(uinteg8_t row, uinteg8_t col,uinteg8_t* Copy_Pntr_su8_LCD_goToRowColumn_Flag)
{
	uinteg8_t u8_address;
	static uinteg8_t su8_LCD_goToRowColumn_Flag=1;	
...
void LCD_stringRowCol(uinteg8_t* Copy_Pntr_u8_LCD_displayString, uinteg8_t row, uinteg8_t col,uinteg8_t* Copy_Pntr_u8_LCD_stringRowCol_Flag)
{
	static uinteg8_t u8_LCD_displayString_FLAG=1;
	static uinteg8_t su8_LCD_goToRowColumn_Flag=1;
	static uinteg8_t su8_LCD_stringRowCol_State=0;	
	if(sgu8_LCD_Execution_Time==LCD_Execution_Delay_Enable)
	{
...
{
	static uinteg8_t su8_LCD_clearScreen_state=1;
 ...
 * integerToString.
 */
void LCD_integerToString(uinteg32_t value,uinteg8_t row,uinteg8_t col,uinteg8_t* Copy_Pntr_su8_LCD_integerToString_FLAG)
{
	static uinteg8_t su8_LCD_integerToString_FLAG=1;
	uinteg32_t arru32_buffer[20];
